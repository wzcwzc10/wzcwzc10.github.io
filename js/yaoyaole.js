const Sakana = (t=>{
    ...
    a.innerHTML = `
        .sakana-box{width:500px;height:800px;position:relative;transform-origin:50% 100%;pointer-events:none}
        .sakana-box canvas{position:absolute;left:0;right:0;bottom:0;pointer-events:none}
        .sakana-box .sakana-character{width:300px;height:300px;position:absolute;left:0;right:0;margin:0 auto;bottom:260px;cursor:pointer;pointer-events:auto;transform-origin:50% 400px;background:no-repeat 50% 50%;background-size:cover}
        .sakana-box .sakana-character[data-character=chisato]{background-image:url(img/jufufu.png)}
        .sakana-box .sakana-character[data-character=takina]{background-image: url(img/jufufu-ht.gif)}
        .sakana-box .sakana-bed{width:160px;height:20px;position:absolute;left:0;right:0;margin:0 auto;bottom:0;background:rgba(255,255,255,.5) no-repeat 50% 50%;border-radius:2px;cursor:pointer;background-image:url(img/page-bg.png);background-size:20px 20px;box-shadow:0 0 0 2px rgba(0,0,0,.05)}
    ...
    const {log: e} = console
      ...
      , r = {
        chisato: {r: 1, y: 40, t: 0, w: 0, d: .99},
        takina: {r: 12, y: 2, t: 0, w: 0, d: .988}
    }
      , s = {
        chisato: new Audio(),
        takina: new Audio(),
    ...
    return {
        init: (t={})=>{
            ...
            ), scale: u="auto", translateY: d=0, strokeStyle: h="#866f14", canSwitchCharacter: l=!1} = t;
